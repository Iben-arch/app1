        ...
        <div className="mt-4 mx-auto p-3 rounded" style={{width:'400px', background:'#cee'}}>
            <form>
                ...
                <div className="form-group mb-2">
                    ...
                    <input type="password" id="pswd" name="pswd" maxLength="10" ref={textPswd} onBlur={onBlurPassword} className="form-control form-control-sm"></input>
                </div>
                <div className="form-group mb-2">
                    <label htmlFor="pswd2">ใส่รหัสผ่านซ้ำ</label>
                    <input type="password" id="pswd2" name="pswd2" maxLength="10" ref={textPswd2} onBlur={onBlurPassword2} className="form-control form-control-sm"></input>
                </div>
                ...
                <div className="text-center">
                    <button type="submit" className = "btn btn-sm px-4 btn-primary">OK</button>
                </div>
            </form>
